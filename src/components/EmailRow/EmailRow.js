...
function EmailRow({ id, title, subject, description, time, starred, important, read, to, from, spam, searchableKeywords, attachments }) 
{
    ...
    const openMail = () => {
        ...
        history.push("/QuMails");
    };
    const rowColor = read ? "white" : "rgb(8, 7, 7)"  
            ...
            <div className={styles.emailRow__options}>
                ...
                <ReactTooltip place="bottom"/>
                    <span data-tip="Star">
                        ...
                        {starred ? <StarIcon style={{fill: "blue"}}/> : <StarBorderOutlinedIcon /> }
                        </IconButton>
                    </span>
                <ReactTooltip place="bottom"/>
                    <span data-tip="Mark As Important">
                        <IconButton onClick={(e) => {
                            ...
                            {important ? <LabelImportantOutlinedIcon style={{fill: "blue"}}/> : <LabelImportantOutlinedIcon /> }
                        </IconButton>
                    </span>
            </div>
